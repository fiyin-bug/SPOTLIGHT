    ...
    <div className="container">
      <div className="text-section">
        ...
        <p className="spotlight-info">
          ...
          <br />
          <br />
          Asides the competition, the regular concert goers have a blast vibing to hits from mainstream artistes, some of who have graced our stage are, The Late MOBHAD, ASAKE, SEYI VIBEZ, T-CLASSIC, DJ CONSEQUENCE, DJ NEPTUNE, DJ DS, see as line up choke na!! And these are just a few of the celebrities that have attended over the years.
          <br />
          <br />
